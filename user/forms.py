...
class LoginForm(forms.Form):
    ...
    password = forms.CharField(label='密码', \
                               widget=forms.PasswordInput(attrs={'class':'form-control','id':'password','placeholder':'请输入密码'}))
...
class RegForm(forms.Form):
    username=forms.CharField(label='用户名',max_length=30,min_length=6, \
                             widget=forms.TextInput(attrs={'class':'form-control','placeholder':'请输入6-30位的用户名'}))
    ...
    password=forms.CharField(label='密码',min_length=6, \
                             widget=forms.PasswordInput(attrs={'class':'form-control','placeholder':'请输入大于6位的密码'}))
